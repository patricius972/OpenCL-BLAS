...
testDgemmColMajorNoTransNoTrans_3x3()
{
  ...
  trimp_dgemm(ColumnMajor, NO, NO, 3, 3, 3, 1.0, a, 3, b, 3, 0.0, c, 3);
...
testDgemmColMajorTransNoTrans_3x3()
{
  ...
  trimp_dgemm(ColumnMajor, YES, NO, 3, 3, 3, 1.0, a, 3, b, 3, 0.0, c, 3);
...
testDgemmColMajorTransNoTrans_3x3_with_lda()
{
  ...
  trimp_dgemm(ColumnMajor, YES, NO, 3, 3, 3, 1.0, a, 4, b, 4, 0.0, c, 4);
...
testDgemmColMajorTransNoTrans_2x3_with_lda()
{
  ...
  trimp_dgemm(ColumnMajor, YES, NO, 2, 2, 3, 1.0, a, 4, b, 3, 0.0, c, 2);
...
testDgemmColMajorTransNoTrans_2x3_with_lda_RowMajor()
{
  ...
  trimp_dgemm(RowMajor, YES, NO, 2, 2, 3, 1.0, a, 3, b, 2, 0.0, c, 2);
